...
def parity56(frame):
    ...
    """
    adsb_msg = [
        eval("0x" + frame[0] + frame[1]),
        eval("0x" + frame[2] + frame[3]),
        eval("0x" + frame[4] + frame[5]),
        eval("0x" + frame[6] + frame[7]),
        eval(
            "0x" + frame[8] + frame[9] + frame[10] + frame[11] + frame[12] + frame[13]
        ),
    ]
...
def parity112(frame):
    ...
    adsb_msg = [
        ...
        eval("0x" + frame[4] + frame[5]),
        eval("0x" + frame[6] + frame[7]),
        eval("0x" + frame[8] + frame[9]),
        eval("0x" + frame[10] + frame[11]),
        eval("0x" + frame[12] + frame[13]),
        eval("0x" + frame[14] + frame[15]),
        eval("0x" + frame[16] + frame[17]),
        eval("0x" + frame[18] + frame[19]),
        eval("0x" + frame[20] + frame[21]),
        eval(
            "0x" + frame[22] + frame[23] + frame[24] + frame[25] + frame[26] + frame[27]
        ),
    ]
