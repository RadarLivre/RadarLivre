# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-08-18 13:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latitude', models.DecimalField(decimal_places=20, default=0.0, max_digits=40)),
                ('longitude', models.DecimalField(decimal_places=20, default=0.0, max_digits=40)),
                ('altitude', models.DecimalField(decimal_places=20, default=0.0, max_digits=40)),
                ('verticalVelocity', models.DecimalField(decimal_places=20, default=0.0, max_digits=40)),
                ('horizontalVelocity', models.DecimalField(decimal_places=20, default=0.0, max_digits=40)),
                ('groundTrackHeading', models.DecimalField(decimal_places=20, default=0.0, max_digits=40)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groundTrackHeading', models.DecimalField(decimal_places=20, default=0.0, max_digits=40)),
                ('timestamp', models.BigIntegerField(default=0)),
                ('adsbInfo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='observation', to='radarlivre_api.ADSBInfo')),
        ...
        migrations.AddField(
            model_name='adsbinfo',
            name='collector',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='observations', to='radarlivre_api.Collector'),
        ),
    ]
