...
class ADSBInfo(models.Model):
    ...
    horizontalVelocity = DecimalField(max_digits=20, decimal_places=15, default=0.0)

    # Airplane angle
    groundTrackHeading = DecimalField(max_digits=20, decimal_places=15, default=0.0)
